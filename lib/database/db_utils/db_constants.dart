...
const TEXT_AND_CANCELICON = 'TEXT_AND_CANCELICON';
const SHADOW_BORDER = 'SHADOW_BORDER';
const HINT_TEXT = 'HINT_TEXT';
const FONT_WHITE_COLOR = 'FONT_WHITE_COLOR';
const PARK_ORDER_BUTTON = 'PARK_ORDER_BUTTON';
const ACTIVE = 'ACTIVE';
